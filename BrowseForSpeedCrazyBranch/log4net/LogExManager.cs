...
namespace LFS.BrowseForSpeed
{
    ...
    /// </para>
    /// <para>
    /// See the <see cref="ILogEx"/> interface for more details.
    /// </para>
    /// </remarks>
    /// <example>Simple example of logging messages
    /// <code lang="C#">
    /// ILogEx log = LogManager.GetLogger("application-log");
    /// 
    ...
    public sealed class LogExManager
    {
        ...
        public static ILogEx Exists(string name)
        {
        ...
        /// repository.
        /// </returns>
        public static ILogEx Exists(string repository, string name)
        {
        ...
        /// </returns>
        public static ILogEx Exists(Assembly repositoryAssembly, string name)
        {
        ...
        public static ILogEx[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers.</returns>
        public static ILogEx[] GetCurrentLoggers(string repository)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers.</returns>
        public static ILogEx[] GetCurrentLoggers(Assembly repositoryAssembly)
        {
        ...
        public static ILogEx GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static ILogEx GetLogger(string repository, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static ILogEx GetLogger(Assembly repositoryAssembly, string name)
        {
        ...
        /// <returns>The logger with the name specified.</returns>
        public static ILogEx GetLogger(Type type)
        {
            if (type == null)
                throw new ArgumentNullException("type", "Invalid logger type.");
        ...
        /// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static ILogEx GetLogger(string repository, Type type)
        {
        ...
        /// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static ILogEx GetLogger(Assembly repositoryAssembly, Type type)
        {
        ...
        private static ILogEx WrapLogger(ILogger logger)
        {
            return (ILogEx)s_wrapperMap.GetWrapper(logger);
        }
        ...
        private static ILogEx[] WrapLoggers(ILogger[] loggers)
        {
            ILogEx[] results = new ILogEx[loggers.Length];
