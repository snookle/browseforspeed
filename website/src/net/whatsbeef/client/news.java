...
public class news {
	public static HTML getHTML () {
		String html = "<div class='page'><H2>Browse For Speed 0.1 - Beta Release!</H2><p><a href='/files/browseforspeed-0.1.zip'>Browse for Speed 0.1</a> - All you need to run it.</p>"
